...
public class Board extends JPanel {
    ...
    /* drow 1 pellet on pos becuase the goust when move in pellet the pellet is hide */
    ...
    public void paint(Graphics g) {
        ...
        /* Detect collisions */
        oops = DetectCollision(oops);

        /* Kill the pacman if oops is true then pac-man is died*/
        KillPacMan(g, oops);
        
        /*return the value for oops to false*/
        oops=false;
                
        /*delete drowing for player and ghost */
        DeleteDrowing(g);
    ...
    public void InitializeGame(Graphics g) {
        if (New == 1) {
            reset();
            ...
            New++;
        } /* Second frame of new game */ else if (New == 2) {
            New++;
        } /* Third frame of new game */ else if (New == 3) {
            New++;
            /* Play the newGame sound effect */
            timer = 0;
            return;
        } /* Fourth frame of new game */ else if (New == 4) {
    ...
    public void InitializeScreen(Graphics g) {
        if (titleScreen) {
            ...
            New = 1;
            return;
        } /* If this is the win screen, draw the win screen and return */ else if (winScreen) {
            g.setColor(Color.BLACK);
            g.fillRect(0, 0, 600, 600);
            g.drawImage(winScreenImage, 0, 0, Color.BLACK, null);
            New = 1;
            return;
        } /* If this is the game over screen, draw the game over screen and return */ else if (overScreen) {
            g.setColor(Color.BLACK);
            g.fillRect(0, 0, 600, 600);
    ...
    public void UpdateHighScore(Graphics g) {
        if (clearHighScores) {
            g.setColor(Color.BLACK);
    ...
    public boolean DetectCollision(boolean oops) {
    ...
    public void EatPellet(Graphics g) {
    ...
    public void DrowGost(Graphics g) {
    ...
    public void DrowPlayer(Graphics g) {
    ...
    public void KillPacMan(Graphics g, boolean oops) {
        if (oops && !stopped) {
            stopped = true;
            if (currScore > highScore) {
                updateScore(currScore);
    ...
    public void DeleteDrowing(Graphics g){
    ...
    public void ReplacePellets(Graphics g){
